(function(){"use strict";(function(){u();const e=window.RagChatbotConfig||{},s=e.widgetKey||e.apiKey||"",a=e.position==="bottom-left"?"bottom-left":"bottom-right",r=p(e.widgetColor)?e.widgetColor:"#2563eb",c=m(e.launcherIcon),b=typeof e.welcomeMessage=="string"?e.welcomeMessage:"",o=document.createElement("div");o.id="rag-chatbot-bubble",o.style.background=r,h(o,a,24),o.innerHTML=w(c),document.body.appendChild(o);const n=document.createElement("iframe");n.id="rag-chatbot-frame";const d=`${e.frontendUrl||"http://localhost:5173"}/widget`,i=new URLSearchParams;s&&i.set("widgetKey",s),i.set("widgetColor",r),i.set("welcomeMessage",b),i.set("launcherIcon",c),n.src=i.toString()?`${d}?${i.toString()}`:d,h(n,a,24),n.classList.add("rag-chatbot-hidden"),document.body.appendChild(n),o.addEventListener("click",()=>{o.classList.add("rag-chatbot-hidden"),n.classList.remove("rag-chatbot-hidden")});function p(t){return typeof t=="string"&&/^#([0-9A-Fa-f]{3}|[0-9A-Fa-f]{6})$/.test(t)}function m(t){return t==="help"||t==="spark"?t:"chat"}function h(t,g,l){t.style.left=g==="bottom-left"?`${l}px`:"auto",t.style.right=g==="bottom-right"?`${l}px`:"auto"}function w(t){return t==="help"?`<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    ...
    </svg>`}function u(){if(document.getElementById("rag-chatbot-widget-styles"))return;const t=document.createElement("style");t.id="rag-chatbot-widget-styles",t.textContent=`
      #rag-chatbot-bubble {
        position: fixed;
        width: 56px;
        height: 56px;
